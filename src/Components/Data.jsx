        ...
        return (
                <div>
                        <div className="home__data">
                                <h1 className="home__title">Madood Maharvi
                                        <svg
                                                width="36"
                                                height="36"
                                                viewBox="0 0 48 48"
                                ...
                                <p className="home description">I'm a skilled web developer located in Poznan, driven by an unwavering passion for crafting exceptional online experiences.</p>
